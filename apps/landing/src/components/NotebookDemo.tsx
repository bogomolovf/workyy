...
const SCENARIOS: Record<
  ScenarioId,
  { label: string; sql: string; python: string; rows: SqlResultRow[]; unit: string }
> = {
  revenue: {
  ...
  return (
    <div className="grid gap-3 lg:gap-4">
      ...
      <div className="board-note text-xs md:text-sm">
        Both cells are mock-backed in the browser: no real warehouse, but the flow matches how
        Workyy runs SQL and Python side by side on one canvas. Switch scenarios to see how one board
