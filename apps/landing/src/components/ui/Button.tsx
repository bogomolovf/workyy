...
export const Button = ({
  ...
  const baseClasses =
    'rounded-lg transition-colors inline-flex items-center justify-center focus-visible:outline-2 focus-visible:outline-dashed focus-visible:outline-wy-primary focus-visible:outline-offset-2';
