  ...
  return (
    <div className="w-[360px] rounded-2xl border border-slate-700 bg-slate-900/80 shadow-lg">
      <div className="flex items-center justify-between border-b border-slate-800 px-4 py-2">
        <span className="text-xs font-semibold uppercase tracking-wide text-slate-400">SQL Node</span>
      ...
      {error && (
        <div className="border-b border-rose-700/40 bg-rose-900/30 px-4 py-2 text-xs text-rose-200">{error}</div>
      )}
